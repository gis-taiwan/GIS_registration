      ...
      <Container fluid>
        <Row>
          <Col md="8">
            <Card>
              <Card.Header>
                <Card.Title as="h4">分析報表（假資料）</Card.Title>
              ...
              <Card.Footer>
                <div className="legend">
                  ...
                  租賃 <i className="fas fa-circle text-danger"></i>
                  記帳 <i className="fas fa-circle text-warning"></i>
                  其它
                </div>
              </Card.Footer>
            </Card>
          ...
          <Col md="4">
            <Card>
              <Card.Header>
                <Card.Title as="h4">一些東西</Card.Title>
